...
void AcceleratorAccelerator__Init( AcceleratorAccelerator _this, XObject aLink, XHandle aArg )
{
  ...
  ViewsText_OnSetAlignment( &_this->FpsText, ViewsTextAlignmentAlignHorzLeft | ViewsTextAlignmentAlignVertCenter );
  ...
  ViewsText_OnSetAlignment( &_this->CpuText, ViewsTextAlignmentAlignHorzRight | 
  ViewsTextAlignmentAlignVertCenter );
  ...
  ViewsText_OnSetAlignment( &_this->ScenDescr, ViewsTextAlignmentAlignHorzCenter 
  | ViewsTextAlignmentAlignVertCenter );
  ...
  ViewsText_OnSetAlignment( &_this->AccelDescr, ViewsTextAlignmentAlignHorzCenter 
  | ViewsTextAlignmentAlignVertCenter );
