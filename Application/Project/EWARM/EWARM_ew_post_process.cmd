...
if exist "%EmWi_OutputDirectory%/../../PlatformPackage/%EmWi_ColorFormat%/ewgfx.c" (
  ...
  set EmWi_RTESrcFiles=ewextrte.c libewrte-m33-iar.a
  if %EmWi_SurfaceRotation% == 0 (
    set EmWi_GFX_SrcFiles=libewgfx-m33-iar.a
  ) else (
    set EmWi_GFX_SrcFiles=libewgfx-m33-r%EmWi_SurfaceRotation%-iar.a
  )
)
