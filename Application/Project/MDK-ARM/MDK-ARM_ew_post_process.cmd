...
if exist "%EmWi_OutputDirectory%/../../PlatformPackage/%EmWi_ColorFormat%/ewgfx.c" (
  ...
  set EmWi_RTELibFiles=libewrte-m33-keil.lib
  if %EmWi_SurfaceRotation% == 0 (
    set EmWi_GFX_LibFiles=libewgfx-m33-keil.lib
  ) else (
    set EmWi_GFX_LibFiles=libewgfx-m33-r%EmWi_SurfaceRotation%-keil.lib
  )
)
