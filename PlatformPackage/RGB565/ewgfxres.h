...
*   aNoOfGlyphIds  - As input parameter determines the capacity of the array
*     aGlyphIds. When the function has finished the processing, the parameter
*     will store how many glyphs are available in the array aGlyphIds.
